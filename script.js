...
/**
 * We no longer intercept the click — the anchor's href
 * already points to the correct download URL, so we let
 * the browser handle it natively (works cross-origin too).
 */
function initDownload() {
  /* Intentionally empty: native <a href> navigation is used. */
}
